...
Serial.println(countL);
  ...
  //if (lineArr[0]==1 && lineArr[1]==1 && lineArr[2]==1 && lineArr[3]==1 && lineArr[4]==1 &&lineArr[5]==1 && lineArr[6]==1 && lineArr[7]==1
  //      if (lineCount == 😎 {
  //
  ...
  //
  //
  if (lineArr[4]==lineArr[7] && lineArr[5]==lineArr[7] && lineArr[6]==lineArr[7] &&lineArr[3]==lineArr[7]&&lineArr[0]!=lineArr[7] ){ 
  ...
  if (lineArr[1]==lineArr[0] && lineArr[2]==lineArr[0] && lineArr[3]==lineArr[0]&& lineArr[4]==lineArr[0]&&lineArr[7]!=lineArr[0]) {
